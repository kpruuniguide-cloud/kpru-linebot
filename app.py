...
def handle_message(event):
    ...
    with ApiClient(configuration) as api_client:
        ...
        filler_words = [
            ...
            "อยู่ที่ไหน", "อยู่ไหน", "ที่ไหน", "ตรงไหน", "ชั้นไหน","อยู่ตรงไหน","อยู่ไหนคะ","อยู่ไหนครับ","อยู่ตรงไหนค่ะ",
            "หน่อย", "ช่วยหา", "ครับ", "ค่ะ", "นะคะ", "นะ", "จ๊ะ","พาฉันไปที่","ไปทางไหน","ไปไหนค้าบ","ไปไหนคะ",
